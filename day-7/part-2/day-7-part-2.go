...
func exhaustive_check(expected_result int, components []int, result int) bool {
	...
	return exhaustive_check(expected_result, components[1:], result + components[0]) || exhaustive_check(expected_result, components[1:], result * components[0]) || exhaustive_check(expected_result, components[1:], concat(result, components[0]))
}

func concat(front int, back int) int {
